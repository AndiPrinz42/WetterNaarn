...
<head>
    ...
    <link rel="stylesheet" href="https://wetter-naarn.at/assets/libraries/chosen/chosen.min.css">
    <link rel="stylesheet" href="https://wetter-naarn.at/assets/css/graph/style.css">

    <!-- Scripts -->
    <script src="https://wetter-naarn.at/assets/libraries/jquery/jquery.min.js"></script>
    <script src="https://wetter-naarn.at/assets/libraries/chosen/chosen.jquery.min.js"></script>
    <script src="https://wetter-naarn.at/assets/libraries/chart/chart.min.js"></script>
    <script src="https://wetter-naarn.at/assets/js/navbar/script.js" defer></script>
    <script src="https://wetter-naarn.at/assets/js/graph/week/script.js" defer></script>
    <?php if(isset($_COOKIE['consent']) && json_decode($_COOKIE['consent'])[1] == 1) include 'https://wetter-naarn.at/assets/google_analytics/'?>
    <title>Wochenwerte | wetter-naarn.at</title>
</head>
...
<body>
    ...
    <div id="content">
        <?php
        include 'https://wetter-naarn.at/assets/html/graph/week/index.html';
        ?>
    </div>
    ...
    if (!isset($_COOKIE['consent']) || json_decode($_COOKIE['consent'])[0] == 1) {
        ...
        echo ('<script src="https://wetter-naarn.at/assets/js/cookie-banner/script.js"></script>');
    }
    ?>
</body>
</html>