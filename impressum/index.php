...
<head>
    <meta charset="UTF-8">
    <!-- <meta name="description" content="ci nisi ipsum accusantium iure pariatur quae laboriosam aspernatur? Dolores consequatur deleniti iste."> -->
    ...
    <link rel="stylesheet" href="https://wetter-naarn.at/assets/css/impressum/style.css">
...
<body>
    ...
    <div id="content">
        <?php
        include 'https://wetter-naarn.at/assets/html/impressum/index.html';
        ?>
    </div>
